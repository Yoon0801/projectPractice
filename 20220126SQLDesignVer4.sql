...
positionCity NVARCHAR(200) NOT NULL
);
GO

INSERT INTO tCity (positionCity)
VALUES
('基隆市'), ('台北市'), ('新北市'), ('桃園市'), ('新竹縣'),
('新竹市'), ('苗栗縣'), ('台中市'), ('彰化縣'), ('南投縣'),
('雲林縣'), ('嘉義縣'), ('嘉義市'), ('台南市'), ('高雄市'),
...
positionCountry NVARCHAR(200) NOT NULL,
FOREIGN KEY (positionBelong) REFERENCES tCity(positionID)
);
GO

INSERT INTO tCountry (positionBelong, positionCountry)
VALUES
...
RescuePosition INT NOT NULL, --下拉式選單
...
FOREIGN KEY (RescuePosition) REFERENCES tCountry(positionID)
);
GO
...
TransferPosition INT NOT NULL, -- 送養地區 >>> 有外鍵
...
FOREIGN KEY (TransferPosition) REFERENCES tCountry(positionID)
);
GO
