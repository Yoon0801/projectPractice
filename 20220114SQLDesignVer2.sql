...
RescueTitle NVARCHAR(200) NOT NULL, -- 通報標題(拾獲/協尋/救援/其他) >>>> 是否要拉出另一個表
ResCueDone BIT NOT NULL, -- 通報進度(進行中/已結束)
RescuePictures NVARCHAR(200) NOT NULL, -- 通報照片(提問1)
RescuePosition INT NOT NULL,
RescueEvent NVARCHAR(200) NOT NULL, -- 通報事件(詳述事件內容)
RescueSpecies INT NOT NULL, -- 通報物種(犬,貓,鳥,鼠,其他) >>> 有外鍵
RescueProgress NVARCHAR(200), -- 通報過程 >>> (提問2)
Created_At DATETIME NOT NULL DEFAULT getDate(), -- 通報建立時間 (提問3)
...
TransferDone BIT NOT NULL, -- 送養進度(開放認養、已被認養) (提問 4 & 5)
TransferPictures NVARCHAR(200) NOT NULL, -- 送養圖片
TransferPosition INT NOT NULL, -- 送養地區 >>> 有外鍵
TransferGender BIT NOT NULL, -- 送養動物性別
TransferName CHAR NOT NULL, -- 送養動物名字
TransferSpecies INT NOT NULL, -- 送養動物種類
TransferNeuter BIT NOT NULL, -- 結紮與否
TransferSituation NVARCHAR(200), -- 送養動物狀態()
TransferRequest NVARCHAR(MAX), -- 認養條件
TransferContactWay VARCHAR(200), -- 送養人聯絡方式
TransferContactPerson NVARCHAR(200), -- 送養人聯絡姓名
Created_At DATETIME NOT NULL DEFAULT getDate(), -- 送養建立時間
...
BlogCategory BIT NOT NULL, -- 文章種類(僅限領養故事/救援心得)
