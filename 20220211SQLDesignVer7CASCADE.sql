...
FollowResueID INT NOT NULL,
FOREIGN KEY (FollowMemberID) REFERENCES tMember(MemberID)ON DELETE CASCADE,
FOREIGN KEY (FollowResueID) REFERENCES tRescue(RescueID)ON DELETE CASCADE
);
GO
...
FollowID INT NOT NULL PRIMARY KEY IDENTITY(1, 1),
FollowMemberID INT NOT NULL ,
FollowTransferID INT NOT NULL,
FOREIGN KEY (FollowMemberID) REFERENCES tMember(MemberID)ON DELETE CASCADE,
FOREIGN KEY (FollowTransferID) REFERENCES tTransfer(TransferID)ON DELETE CASCADE
);
GO
...
FOREIGN KEY (CommentMemberID) REFERENCES tMember(MemberID)ON DELETE CASCADE,
FOREIGN KEY (CommentRescueID) REFERENCES tRescue(RescueID) ON DELETE CASCADE
)
