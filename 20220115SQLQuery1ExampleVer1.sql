...
RescuePosition, RescueEvent, RescueSpecies, RescueProgress)
VALUES
('1', '救援', '未結案', '1.img', '112', '狗車禍', '1', 'XXX：需要紙箱、車子前往醫院'),
('2', '拾獲', '未結案', '2.img', '210', '黃色貓咪', '2', 'OOO：在OO路上撿到'),
('3', '協尋', '已結案', '3.img', '38', '黑色土狗', '1', 'OOO：在XX路附近受到驚嚇走失'),
('4', '救援', '未結案', '4.img', '232', '狗狗車禍', '1', 'XXX：我不敢撿狗'),
('5', '救援', '已結案', '5.img', '142', '貓車禍', '2', 'XXX：需要紙箱、車子前往醫院'),
('6', '拾獲', '已結案', '6.img', '87', '白色土狗', '1', 'YYY：在SS公園跟著我回家...'),
('7', '救援', '未結案', '7.img', '121', '貓車禍', '2', 'XXX：需要紙箱、車子前往醫院'),
('8', '拾獲', '未結案', '8.img', '308', '白色兔子', '5', 'XXX：為什麼OO路上會有兔子...'),
('9', '救援', '已結案', '9.img', '177', '貓咪卡在屋頂', '1', 'JJJ：需要樓梯跟身體柔軟的人'),
('10', '拾獲', '已結案', '10.img', '288', '綠色鸚鵡', '3', 'XXX：OO路附近自動飛進家裡');
GO
